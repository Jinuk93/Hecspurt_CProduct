	...
	<div id="fullpage">
		<section class="section" style="background-attachment: fixed;">
			<div class="sildeDiv">
				<ul>
					<li>
						<img src="/Hecspurt_cproduct/image/main_fullscroll_first.jpg" alt="mainpic1.jpg" id="image1">
					</li>
					<li>
						<img src="/Hecspurt_cproduct/image/main_fullscroll_second.jpg" alt="mainImage2.jpg" id="image2">
					</li>
					<li>
						<img src="/main_fullscroll_third.jpg" alt="imageSlide.jpg" id="image3">
					</li>
				</ul>
