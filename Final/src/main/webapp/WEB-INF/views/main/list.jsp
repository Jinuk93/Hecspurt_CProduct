                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            제품 리스트
                            <button id="regBtn" type="button" class="btn btn-xs btn-info pull-right ">글쓰기</button>
                        </div>
                        <!-- /.panel-heading -->
                            	...
                            	<div class="col-lg-12">
                            		<form id='searchForm' action="/board/list" method="get">
				                      <select class="form-group" name="type">
				                         ...
				                         <option value="TW"<c:out value="${criteria.type eq 'TW'?'selected':''}"/>>제목OR작성자</option>
				                         <option value="TCW"<c:out value="${criteria.type eq 'TCW'?'selected':''}"/>>제목 OR 내용 OR 작성자</option>
