...
<form id="writeOkForm">
	<div id="writeOkBox">
		...
		<div id="writeOkBtn">
			<input type="button" id="writeOkHomeBtn" class="btn" value="홈으로" onclick="location.href='/index'">
			<input type="button" id="writeOkLoginBtn" class="btn" value="로그인" onclick="location.href='/login/loginForm'">
		</div>
	</div>
</form>